class MaxHeap{
    ...
    bubbleUp(){
        ...
        // 현재 인덱스의 부모 노드가 존재하고, 부모 노드 값보다 현재 인덱스의 값이 클 동안 반복한다.
    ...
    bubbleDown(){
        // 최상단 인덱스를 저장한다.
        let index = 0;
        // 현재 인덱스의 왼쪽 자식 노드가 존재하고, 왼쪽 자식 노드의 값과 오른쪽 자식 노드의 값이 현재 인덱스의 값보다 클 동안 반복한다.
        ...
        (this.leftChild(index) > this.items[index] || this.rightChild(index > this.items[index]))){
            ...
            // 오른쪽 자식 노드 값이 존재하고 오른쪽 자식 노드의 값이 왼쪽 자식 노드의 값보다 크다면
